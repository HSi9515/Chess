...
public class King extends Piece{
	...
	public boolean isValidMove(Location from, Location to, Piece[][]b) {
		...
		if(isFirstTurn() && to.getRow() == from.getRow() && (to.getColumn() == 6 ||
				to.getColumn() == 2)){
			...
			if(to.getColumn() == 6){
				...
				else if(b[from.getRow()][0].isFirstTurn() && leftCounter == 3){
...
//			}
//		}
//		This was old code for preventing King from moving into check. Now replaced with the two-liner below. :)
